...
![](/markdown/5451f7444ebe57685a8ac58421bcfcca.png)
...
![](/markdown/61effa0f7928513f83fb7f47e7748217.png)

**启动客户端：**

![](/markdown/df646b0fab71ab3c3a299c4154909433.png)

这里客户端的执行最后报了一个错误，那是我们 **故意为之**，目的是演示 `GRPC` 报错时的链路信息展示。我们打开 `jaeger` 查看一下链路跟踪信息：

![](/markdown/99d05926e06babb982bb8678e8865775.png)
...
![](/markdown/d0eaa3b72d3ee6c7f79c730d34b1cc73.png)

我们点击查看一下最后接口调用错误的 `span` 情况：

![](/markdown/6a1b7febc50345cd86ce793dcb17fa5b.png)

看起来像个参数校验错误，点击查看 `Events/Logs` 中的请求参数：

![](/markdown/35c3c643a19f21da59c70eb04902fb45.png)
...
![](/markdown/53b80ca2b40971d05f868c0236e67fe9.png)
...
![](/markdown/973df7b2828dc31374832cfb4bcd3089.png)
...
![](/markdown/1435960f65fc8fb506da9c5ad7f6934f.png)

`GRPC Server` 端的 `Attributes` 含义同 `GRPC Client`，在同一请求中，打印的数据基本一致。

#### Events

![](/markdown/a23ca93a6633fa662ffa38c6727dd187.png)
