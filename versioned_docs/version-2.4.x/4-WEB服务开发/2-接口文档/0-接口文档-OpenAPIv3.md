...
`OpenAPIv3` 协议主要使用在规范路由中，阅读接口文档协议介绍之前，请先了解一下规范路由： [路由注册-规范路由](output/goframe-v2.4-md/WEB服务开发/路由管理/路由管理-路由注册/路由注册-规范路由)
...
关于元数据组件的介绍，详情请参考章节： [元数据-gmeta](output/goframe-v2.4-md/组件列表/实用工具/元数据-gmeta)
...
![](/markdown/df6468cf13e1399c2fffc5f7009d94eb.png)
