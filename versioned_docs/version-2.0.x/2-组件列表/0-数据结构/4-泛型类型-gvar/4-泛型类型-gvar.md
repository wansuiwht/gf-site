...
- [泛型类型-基本使用](output/goframe-v2.0-md/组件列表/数据结构/泛型类型-gvar/泛型类型-基本使用)
- [泛型类型-方法介绍](output/goframe-v2.0-md/组件列表/数据结构/泛型类型-gvar/泛型类型-方法介绍)
- [泛型类型-注意事项](output/goframe-v2.0-md/组件列表/数据结构/泛型类型-gvar/泛型类型-注意事项)