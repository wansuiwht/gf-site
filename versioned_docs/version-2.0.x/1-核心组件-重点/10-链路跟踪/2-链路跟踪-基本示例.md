...
![](/markdown/055715dc8906431d04620ba5bf94b784.png)

打开 `Jaeger UI`: [http://localhost:16686/search](http://localhost:16686/search)，可以看到链路追踪的结果：![](/markdown/7dabfd34453ca7e0f47105ea58a424bc.jpg)

![](/markdown/9104e11daba7e7200acaea047eb588c1.png)

点击详情可以查看具体信息，包括 `span` 的调用顺序、调用关系，执行时间轴，以及记录一些Attributes和 `Events` 信息，极大的方便我们定位系统中的异常和发现性能瓶颈。：

![](/markdown/b66f9654cb2ff6533c3989ca8b1d1305.png)
