...
sidebar_position: 1
hide_title: true
keywords: [GoFrame,模板函数,内置函数,plus函数,minus函数,times函数,divide函数,字符串操作,日期格式化,url转义]
description: '介绍GoFrame框架中模板使用的内置函数，这些函数可以用于数学计算、HTML和URL转义、字符串处理、日期格式化以及数据格式转换，包括plus、minus、times、divide等函数，提升开发效率。'
---
