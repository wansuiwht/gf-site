...
sidebar_position: 2
hide_title: true
keywords: [GoFrame,微服务,GRPC,脚手架,服务端,客户端,上下文,负载均衡,注册发现,etcd]
description: 'GoFrame框架中的脚手架模块提供了便捷的GRPC服务端和客户端实现，包含上下文、负载均衡和服务注册发现等功能。通过grpcx组件，用户可以轻松地构建和管理微服务应用，支持多种负载均衡策略以及etcd注册中心，简化服务间通信与数据传递。'
---
