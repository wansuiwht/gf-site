...
![](/markdown/e5f30f5d09525131b61c6d0d66ef7ca5.png)
...
![](/markdown/8b04fbecd4ba7d977a09b293fd4fd27e.png)
...
![](/markdown/5a01d201a44fdd44016df773a6aa18eb.png)

5. 请按快捷键 `⌥(option)+↩(return)` 或者 鼠标右键, 选择 `Sync packages of my-hello`

![](/markdown/ce67cd5867b324a66e1bfba32c3d92f4.png)

6. 随后等待几秒钟之后, 可以看到左侧的 `Go Module` 已经有内容，并且中终端自动输出了下载的框架版本

![](/markdown/d3a44464f9a14a60f08949968f8fdda0.png)
...
![](/markdown/ba174dc6dbaadf3d13bccbeff0857e19.png)
...
![](/markdown/0c0fcf7ccc479b94b63ea83dc5fa0130.png)
