...
![](/markdown/bd1ace98223e14ff28bc9246781ab264.png)
...
![](/markdown/6a0318960fb84b19217e85c01d38dee6.png)

**启动客户端：**

![](/markdown/edfa66589f2e4933d3e0a01e93938e7c.png)

这里客户端的执行最后报了一个错误，那是我们 **故意为之**，目的是演示 `GRPC` 报错时的链路信息展示。我们打开 `jaeger` 查看一下链路跟踪信息：

![](/markdown/57640a4cc6283f0306af62ebf193daf4.png)
...
![](/markdown/5a8de66e02d96932b3cd33dc11909d09.png)

我们点击查看一下最后接口调用错误的 `span` 情况：

![](/markdown/a9072bdd9ee4d57ddb1d1bb437dbfd27.png)

看起来像个参数校验错误，点击查看 `Events/Logs` 中的请求参数：

![](/markdown/79248a8e8bc0438ee16cff4206833041.png)
...
![](/markdown/4fa5f793d5794a6497e6340f629f56b7.png)
...
![](/markdown/254dcc89176e134aa575059c49d83f4b.png)
...
![](/markdown/10dab3a8bf0cbb8bec839a318df2ebaf.png)

`GRPC Server` 端的 `Attributes` 含义同 `GRPC Client`，在同一请求中，打印的数据基本一致。

#### Events

![](/markdown/ad69cc2f7834225810e8b44382ea9d15.png)
