...
![](/markdown/1f5ecd87e6a10db0498eb70b170c2e90.png)
...
![](/markdown/18247f48fc1e5c421b036d75ff42f6e9.png)
...
如果规范化定义了枚举值，并且通过命令生成了枚举值维护文件，那么在参数校验中可以使用 `enums` 规则对枚举值字段进行校验，具体规则介绍请参考章节： [数据校验-校验规则](output/goframe-v2.6-md/核心组件/数据校验/数据校验-校验规则)