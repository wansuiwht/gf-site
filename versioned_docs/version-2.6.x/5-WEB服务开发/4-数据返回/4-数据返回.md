...
- [数据返回-缓冲控制](output/goframe-v2.6-md/WEB服务开发/数据返回/数据返回-缓冲控制)
- [数据返回-JSON/XML](output/goframe-v2.6-md/WEB服务开发/数据返回/数据返回-JSONXML)
- [数据返回-Redirect](output/goframe-v2.6-md/WEB服务开发/数据返回/数据返回-Redirect)
- [数据返回-Exit控制](output/goframe-v2.6-md/WEB服务开发/数据返回/数据返回-Exit控制)
- [数据返回-文件下载](output/goframe-v2.6-md/WEB服务开发/数据返回/数据返回-文件下载)
- [数据返回-模板解析](output/goframe-v2.6-md/WEB服务开发/数据返回/数据返回-模板解析)
- [数据返回-Stream返回](output/goframe-v2.6-md/WEB服务开发/数据返回/数据返回-Stream返回)