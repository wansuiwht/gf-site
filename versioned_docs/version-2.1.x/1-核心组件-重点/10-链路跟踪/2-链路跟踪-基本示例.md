...
![](/markdown/4850d1a820a257c980401e7da6ed25ab.png)

打开 `Jaeger UI`: [http://localhost:16686/search](http://localhost:16686/search)，可以看到链路追踪的结果：![](/markdown/410594ced275bb11495e1ef7eab82ad7.jpg)

![](/markdown/47fe5809886a03e41f95b720da39200b.png)

点击详情可以查看具体信息，包括 `span` 的调用顺序、调用关系，执行时间轴，以及记录一些Attributes和 `Events` 信息，极大的方便我们定位系统中的异常和发现性能瓶颈。：

![](/markdown/71812c0b4578c833501282e28c18c55c.png)
