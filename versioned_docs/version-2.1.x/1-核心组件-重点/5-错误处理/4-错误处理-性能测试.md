...
常用方法的基准性能测试： [https://github.com/gogf/gf/v2/blob/master/errors/gerror/gerror\_z\_bench\_test.go](https://github.com/gogf/gf/v2/blob/master/errors/gerror/gerror_z_bench_test.go)
