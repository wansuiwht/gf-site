...
允许接口跨域往往是需要结合 [路由管理-中间件/拦截器](output/goframe-v2.1-md/WEB服务开发/路由管理/路由管理-中间件拦截器.md) 一起使用，来统一设置某些路由规则下的接口可以跨域访问。同时，针对允许 `WebSocket` 的跨域请求访问，也是通过该方式来实现。
...
![](/markdown/bab19e597ac9ecbe0556790b26a5c509.png)
...
![](/markdown/813568a322d62ac5c58885690ebd8415.png)
