...
配置文件路径优先查找当前目录下的 `hack` 目录，其次按照框架默认的配置路径检索配置文件。框架默认的配置文件检索路径请参考章节： [配置管理-文件配置](output/goframe-v2.1-md/核心组件-重点/配置管理/配置管理-文件配置)
...
由于 `gf` 工具也是使用 `GoFrame` 框架开发，因此调试信息的开启也是同框架方式一致，更详细的介绍请参考框架介绍文档： [调试模式](output/goframe-v2.1-md/核心组件-重点/调试模式)
...
- [工具安装-install](output/goframe-v2.1-md/开发工具/工具安装-install)
- [版本查看-version](output/goframe-v2.1-md/开发工具/版本查看-version)
- [项目创建-init](output/goframe-v2.1-md/开发工具/项目创建-init)
- [交叉编译-build](output/goframe-v2.1-md/开发工具/交叉编译-build)
- [代码生成-gen](output/goframe-v2.1-md/开发工具/代码生成-gen)
...
- [自动编译-run](output/goframe-v2.1-md/开发工具/自动编译-run)
- [资源打包-pack](output/goframe-v2.1-md/开发工具/资源打包-pack)
- [镜像编译-docker](output/goframe-v2.1-md/开发工具/镜像编译-docker)
- [工具帮助-help](output/goframe-v2.1-md/开发工具/工具帮助-help)