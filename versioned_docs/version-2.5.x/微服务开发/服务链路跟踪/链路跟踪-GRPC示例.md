...
![](/markdown/2e81c97b21c22628e24c3b3e4dd7cc9e.png)
...
![](/markdown/d4b42629a14d2e38f6a506c7206c84c5.png)

**启动客户端：**

![](/markdown/b7e0f846e05344de02c03f45eaedbdd6.png)

这里客户端的执行最后报了一个错误，那是我们 **故意为之**，目的是演示 `GRPC` 报错时的链路信息展示。我们打开 `jaeger` 查看一下链路跟踪信息：

![](/markdown/18d48bb3f039d4b73d6a67f8fa33cdb8.png)
...
![](/markdown/9962aba082bcb9b7df71b88b455dbca9.png)

我们点击查看一下最后接口调用错误的 `span` 情况：

![](/markdown/d315291524a2c7ea00df18476ec486d0.png)

看起来像个参数校验错误，点击查看 `Events/Logs` 中的请求参数：

![](/markdown/95d486b34aeab37652314458e995a865.png)
...
![](/markdown/c1063c61cb9f067dec2e1c2e996eeedb.png)
...
![](/markdown/f98a76e89debeeba99ffaa10754cbfcd.png)
...
![](/markdown/0c1602211a15d9cad9e2ddc394368cae.png)

`GRPC Server` 端的 `Attributes` 含义同 `GRPC Client`，在同一请求中，打印的数据基本一致。

#### Events

![](/markdown/8a6bc93393e6eeb483dc2cda79f8cf0c.png)
