...
目前平滑重启特性需要在本地打开一个 `10000` 端口的 `tcp` 监听服务（如果端口被占用，会递加端口）。
...
![](/markdown/7b655afe89b40269297f5ea715438e9d.png)
