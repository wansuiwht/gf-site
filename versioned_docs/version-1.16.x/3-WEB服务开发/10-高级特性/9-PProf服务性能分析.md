...
![](/markdown/cd4ecf4923a532ce40010ede18379f12.png)

2、堆使用量

![](/markdown/b54e813a0ee3c1d44a03b8e757033b5b.png)

3、当前进程中的 `goroutine` 详情

![](/markdown/513b819cbab648dee8beac3a2cd9b552.png)
...
![](/markdown/ccd2c60202ccb0a664216bd6b31ff4dd.png)
...
Showing top 10 nodes out of 19
  ...
  512.14kB 33.33% 66.67%   512.14kB 33.33%  github.com/gogf/gf/container/gmap.(*StrAnyMap).doSetWithLockCheck
  512.06kB 33.33%   100%   512.06kB 33.33%  net.newFD (inline)
         0     0%   100%   512.14kB 33.33%  github.com/gogf/gf/container/gmap.(*StrAnyMap).GetOrSetFuncLock
         0     0%   100%   512.06kB 33.33%  github.com/gogf/gf/net/ghttp.(*Server).startServer.func1
         0     0%   100%   512.06kB 33.33%  github.com/gogf/gf/net/ghttp.(*gracefulServer).ListenAndServe
         0     0%   100%   512.06kB 33.33%  github.com/gogf/gf/net/ghttp.(*gracefulServer).doServe
         0     0%   100%   512.14kB 33.33%  github.com/gogf/gf/os/gres.Instance
         0     0%   100%   512.14kB 33.33%  github.com/gogf/gf/os/gres.init
...
![](/markdown/e1c46ac58494326afb3ea81ccfe66a7a.png)