...
以下是一个简单的自定义数据结构的示例，用于客户端上报当前主机节点的内存及CPU使用情况，示例代码位于： [https://github.com/gogf/gf/tree/master/geg/net/gtcp/pkg\_operations/monitor](https://github.com/gogf/gf/tree/master/geg/net/gtcp/pkg_operations/monitor)
