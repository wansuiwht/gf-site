...
允许接口跨域往往是需要结合 [中间件/拦截器](output/goframe-v1.14-md/WEB服务开发/路由注册/中间件拦截器) 一起使用，来统一设置某些路由规则下的接口可以跨域访问。同时，针对允许 `WebSocket` 的跨域请求访问，也是通过该方式来实现。
...
![](/markdown/ce2de673cfbe512f6e9603a827c5e7ac.png)
...
![](/markdown/c76ebc267282ff1e2bd71068ad79cb08.png)
