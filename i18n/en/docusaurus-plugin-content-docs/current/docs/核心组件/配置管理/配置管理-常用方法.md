...
- Description: The `GetAdapter` method retrieves the current running `gcfg` adapter information. For more about adapters, you can click here [Configuration - Interface Design](./配置管理-接口化设计/配置管理-接口化设计.md)
- Format:
...
- Description: The `SetAdapter` method sets the current running `gcfg` adapter information. For more about adapters, you can click here [Configuration - Interface Design](./配置管理-接口化设计/配置管理-接口化设计.md)
- Format:
