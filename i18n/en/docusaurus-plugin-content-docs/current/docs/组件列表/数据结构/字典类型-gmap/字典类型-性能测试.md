...
title: 'Dictionary Type - Performance Testing'
sidebar_position: 1
hide_title: true
...
Let's take a look at the benchmark comparison results: [https://github.com/gogf/gf/v2/blob/master/container/gmap/gmap\_z\_bench\_syncmap\_test.go](https://github.com/gogf/gf/v2/blob/master/container/gmap/gmap_z_bench_syncmap_test.go)
