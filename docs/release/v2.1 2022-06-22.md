...
视频介绍： [2022-06-22 GoFrame v2.1功能特性&使用答疑](../docs/技术分享交流/5-2022-06-22%20GoFrame%20v2.1功能特性&使用答疑.md)
...
2. `gjson`
1. 新增对 `property` 文件格式的编解码、数据操作支持： [通用编解码-gjson](../docs/组件列表/编码解码/通用编解码-gjson.md)
2. 修复对大整形数据读取的精度丢失问题。
