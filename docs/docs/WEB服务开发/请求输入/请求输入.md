...
sidebar_position: 3
hide_title: true
keywords: [GoFrame,GoFrame框架,ghttp.Request,参数获取,路由参数,GET请求,POST请求,请求方法,前端开发,后端集成]
description: '本文档介绍了如何在GoFrame框架中通过ghttp.Request对象实现对请求输入的处理。参数获取方式丰富，包括Get、GetQuery、GetForm等常用方法，支持多种提交类型和参数类型的自动转换。文档还探讨了参数名称大小写敏感的问题及其对API对象接受参数的影响，并提供了完整的使用示例，帮助开发者更好地理解与应用。'
---
