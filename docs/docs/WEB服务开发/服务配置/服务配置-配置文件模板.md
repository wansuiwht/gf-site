...
sidebar_position: 1
hide_title: true
keywords: [GoFrame框架,服务配置,配置文件模板,ServerConfig,HTTP Server,TLS/HTTPS,静态文件服务,日志配置,Cookie配置,Sessions配置]
description: '本文档提供了一个GoFrame框架服务配置的文件模板，详细介绍了各项配置参数，如地址监听、TLS/HTTPS配置、静态服务、Cookie和Sessions设置、日志记录等，帮助用户更好地使用和配置GoFrame HTTP Server。'
---
