---
slug: '/docs/network/gtcp-conn-package'
title: '连接对象-消息包处理'
sidebar_position: 0
hide_title: true
keywords: [TCP,粘包,gtcp,GoFrame,数据协议,封包解包,消息包,网络通信,简单协议,消息交互]
description: '本篇文档介绍了如何使用gtcp模块及其封包解包处理功能解决TCP消息协议的粘包问题。通过使用GoFrame框架的简单轻量级数据交互协议，开发者可以更轻松地进行消息包交互，无需关注复杂的封包解包细节。此外，文档还提供了多个使用示例，以帮助开发者更好理解和实现自定义数据结构的消息传递。'
---
