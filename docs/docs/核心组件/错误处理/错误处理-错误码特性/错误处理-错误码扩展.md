...
description: '本文档介绍了如何在GoFrame框架中进行错误处理，尤其是错误码的扩展。通过使用错误码的Detail参数，可以根据业务需求自定义错误码。在具体场景中，我们可以通过WithCode方法灵活地创建新的错误码，并在中间件中进行应用和处理。该解决方案不仅增强了业务逻辑的灵活性，还为上层提供了详细的错误信息。'
---
