...
description: '本文档介绍了GoFrame框架中监控告警内置指标的使用方法，涵盖了如何通过otelmetric开启Go基础指标，以及如何结合Prometheus和OpenTelemetry进行性能监控和优化。文中提供了示例代码和详细的指标说明，包括指标名称、指标类型以及描述，以帮助用户理解和实施性能监测。'
---
