...
description: '本页面介绍了如何在GoFrame框架下使用异步监控指标，详细说明了ObservableCounter、ObservableUpDownCounter和ObservableGauge三种异步指标的使用方法。通过定义Callback函数管理指标数值变化，并利用Prometheus导出指标数据。'
---
